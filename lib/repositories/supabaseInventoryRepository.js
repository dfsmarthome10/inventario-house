...
function toInsertPayload(input) {
  ...
  return {
    ...
    container_type: normalized.container_type ?? null,
    parent_container_name: normalized.parent_container_name ?? null,
    sistema_logico: Boolean(normalized.sistema_logico),
...
function toUpdatePayload(currentItem, updates) {
  ...
  return {
    ...
    container_type: merged.container_type ?? null,
    parent_container_name: merged.parent_container_name ?? null,
    sistema_logico: Boolean(merged.sistema_logico),
