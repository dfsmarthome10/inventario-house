...
export async function getOrCreateOpenHouseSession() {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.getOrCreateOpenHouseSession();
}

export async function getOrCreateOpenHouseholdSession() {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.getOrCreateOpenHouseholdSession();
}
...
export async function getHouseCatalog(filters) {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.getHouseCatalog(filters);
}
...
export async function confirmHousePurchase(sessionId) {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.confirmHousePurchase(sessionId);
}

export async function confirmUnifiedPurchase(sessionId) {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.confirmUnifiedPurchase(sessionId);
}
...
export async function getPurchaseHistoryCalendar(month, filters) {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.getPurchaseHistoryCalendar(month, filters);
}
...
export async function getFoodPurchaseSignals(daysBack) {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.getFoodPurchaseSignals(daysBack);
}

export async function getOpenCartBadgeCounts() {
  assertSupabaseDataSource();
  return supabaseShoppingRepository.getOpenCartBadgeCounts();
}
